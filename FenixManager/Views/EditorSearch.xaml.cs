...
namespace FenixWPF
{
    ...
    /// </summary>
    public partial class FrEditorWPFSearch : Window
    {
        ...
        public FrEditorWPFSearch(TextEditor editor)
        {
            InitializeComponent();
        ...
        private static FrEditorWPFSearch theDialog = null;

        public static void ShowForReplace(TextEditor editor)
        {
            if (theDialog == null)
            {
                theDialog = new FrEditorWPFSearch(editor);
